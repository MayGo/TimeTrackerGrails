...
class AppTrackItemController {
	...
	def timeline(){
		params.max = 100
		def l=AppTrackItem.list(params).collect{['taskName':'Application',id:it.tag.name,name:it.tag.name, startDate:it.beginDate.getTime() , endDate:it.endDate.getTime() ]}
    ...
    def show(Long id) {
        ...
        if (!appTrackItemInstance) {
            flash.message = message(code: 'default.not.found.message', args: [message(code: 'appTrackItem.label', default: 'AppTrackItem'), id])
    ...
    def delete(Long id) {
        ...
        try {
            ...
            flash.message = message(code: 'default.deleted.message', args: [message(code: 'appTrackItem.label', default: 'AppTrackItem'), id])
            redirect(action: "list")
        }
        catch (DataIntegrityViolationException e) {
            flash.message = message(code: 'default.not.deleted.message', args: [message(code: 'appTrackItem.label', default: 'AppTrackItem'), id])
